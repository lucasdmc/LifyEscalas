...
const Sidebar: React.FC<SidebarProps> = ({ activeItem, onItemClick }) => {
  const [expandedItems, setExpandedItems] = useState<string[]>(['schedule', 'settings']);
  ...
  const menuItems = [
    ...
    { 
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          <path d="M16 4c0-1.11.89-2 2-2s2 .89 2 2-.89 2-2 2-2-.89-2-2zm4 18v-6h2.5l-2.54-7.63A1.5 1.5 0 0 0 18.54 8H17c-.8 0-1.54.37-2.01.99L14 10.5 11.5 8c-.46-.62-1.21-.99-2.01-.99H7.46c-.8 0-1.54.37-2.01.99L2.5 16H5v6h2v-6h2.5l2.5-4 2.5 4H13v6h2z"/>
        </svg>
      )
    },
    { 
        ...
        {menuItems.map((item) => (
          <div key={item.id} className="menu-section">
            ...
            >
              ...
              {item.subItems && (
                <span className={`expand-icon ${expandedItems.includes(item.id) ? 'expanded' : ''}`}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            {item.subItems && (
              <div className={`sub-menu ${expandedItems.includes(item.id) ? 'expanded' : 'collapsed'}`}>
